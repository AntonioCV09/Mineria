...
# ==========================
# 4. Statistic Test (ANOVA + T-Test / Kruskal-Wallis)
# ==========================
...
# ==========================
# 8. Forecasting (Time Series Linear Regression)
# ==========================
...
plt.plot(pd.date_range(monthly_avg['fecha'].iloc[-1], periods=12, freq='MS')[1:], future_y, label='Pronóstico', linestyle='--')
plt.legend()
